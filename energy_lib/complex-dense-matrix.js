...
class ComplexDenseMatrix {
     ...
     * @method module:LinearAlgebra.ComplexDenseMatrix#timesCWise
     * @param {module:LinearAlgebra.ComplexDenseMatrix} B The complex dense matrix this complex dense matrix
     * is coef. multiplied by.
     * @returns {module:LinearAlgebra.ComplexDenseMatrix}
     */
    timesCWise(B) {
        return new ComplexDenseMatrix(this.data.timesCWise(B.data));
    }
    /**
     * Returns A ./ B (the coef. quotient)
     * @method module:LinearAlgebra.ComplexDenseMatrix#timesCWise
     * @param {module:LinearAlgebra.ComplexDenseMatrix} B The complex dense matrix this complex dense matrix 
     *  is coeff quotient by.
     * @returns {module:LinearAlgebra.ComplexDenseMatrix}
     */
    overCWise(B) {
        return new ComplexDenseMatrix(this.data.overCWise(B.data));
    }

    /**
    * Returns an expression of the Schur product (coefficient wise product) of *this and other
    * @method module:LinearAlgebra.ComplexDenseMatrix#absCWise
    * @returns {module:LinearAlgebra.ComplexDenseMatrix}
    */
    absCWise() {
        return new ComplexDenseMatrix(this.data.absCWise());
    }
     ...
     * @method module:LinearAlgebra.ComplexDenseMatrix#inverseCWise
     * @return {module:LinearAlgebra.ComplexDenseMatrix}
     */
    inverseCWise() {
        return new ComplexDenseMatrix(this.data.inverseCWise());
    }
	/**
	 * Returns A(i, j)
